...
Future<void> main() async {
  ...
  runApp(RelaydApp(prefs: prefs));
}

class RelaydApp extends StatefulWidget {
  final SharedPreferences prefs;
  const RelaydApp({super.key, required this.prefs});

  @override
  State<RelaydApp> createState() => _RelaydAppState();
}

class _RelaydAppState extends State<RelaydApp> {
  late final addrController = TextEditingController(
      text: widget.prefs.getString('admin_addr') ?? 'http://127.0.0.1:8081');
