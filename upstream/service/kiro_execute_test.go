...
func TestKiroExecuteUsesUpstreamRuntimeAndEmitsNDJSON(t *testing.T) {
	...
	canonical, _ := json.Marshal(ir.Request{Model: "public", Messages: []ir.Message{{Role: ir.RoleUser, Content: []ir.Block{{Type: ir.BlockText, Text: "hi"}}}}})
	envelope, _ := json.Marshal(upstreamv1.KiroExecuteRequest{TargetID: "kiro/public", Request: canonical})
